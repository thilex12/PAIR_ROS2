...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_Goal & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_Goal & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_Goal>()
{
  return "turtlesim_msgs::action::RotateAbsolute_Goal";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_Goal>()
{
  return "turtlesim_msgs/action/RotateAbsolute_Goal";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_Result & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_Result & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_Result>()
{
  return "turtlesim_msgs::action::RotateAbsolute_Result";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_Result>()
{
  return "turtlesim_msgs/action/RotateAbsolute_Result";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_Feedback & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_Feedback & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_Feedback>()
{
  return "turtlesim_msgs::action::RotateAbsolute_Feedback";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_Feedback>()
{
  return "turtlesim_msgs/action/RotateAbsolute_Feedback";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_SendGoal_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_SendGoal_Request & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_SendGoal_Request>()
{
  return "turtlesim_msgs::action::RotateAbsolute_SendGoal_Request";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_SendGoal_Request>()
{
  return "turtlesim_msgs/action/RotateAbsolute_SendGoal_Request";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_SendGoal_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_SendGoal_Response & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_SendGoal_Response>()
{
  return "turtlesim_msgs::action::RotateAbsolute_SendGoal_Response";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_SendGoal_Response>()
{
  return "turtlesim_msgs/action/RotateAbsolute_SendGoal_Response";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_SendGoal_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_SendGoal_Event & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_SendGoal_Event>()
{
  return "turtlesim_msgs::action::RotateAbsolute_SendGoal_Event";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_SendGoal_Event>()
{
  return "turtlesim_msgs/action/RotateAbsolute_SendGoal_Event";
}
...
template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_SendGoal>()
{
  return "turtlesim_msgs::action::RotateAbsolute_SendGoal";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_SendGoal>()
{
  return "turtlesim_msgs/action/RotateAbsolute_SendGoal";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_GetResult_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_GetResult_Request & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_GetResult_Request>()
{
  return "turtlesim_msgs::action::RotateAbsolute_GetResult_Request";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_GetResult_Request>()
{
  return "turtlesim_msgs/action/RotateAbsolute_GetResult_Request";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_GetResult_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_GetResult_Response & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_GetResult_Response>()
{
  return "turtlesim_msgs::action::RotateAbsolute_GetResult_Response";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_GetResult_Response>()
{
  return "turtlesim_msgs/action/RotateAbsolute_GetResult_Response";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_GetResult_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_GetResult_Event & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_GetResult_Event>()
{
  return "turtlesim_msgs::action::RotateAbsolute_GetResult_Event";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_GetResult_Event>()
{
  return "turtlesim_msgs/action/RotateAbsolute_GetResult_Event";
}
...
template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_GetResult>()
{
  return "turtlesim_msgs::action::RotateAbsolute_GetResult";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_GetResult>()
{
  return "turtlesim_msgs/action/RotateAbsolute_GetResult";
}
...
[[deprecated("use turtlesim_msgs::action::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::action::RotateAbsolute_FeedbackMessage & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::action::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::action::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::action::RotateAbsolute_FeedbackMessage & msg)
{
  return turtlesim_msgs::action::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute_FeedbackMessage>()
{
  return "turtlesim_msgs::action::RotateAbsolute_FeedbackMessage";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute_FeedbackMessage>()
{
  return "turtlesim_msgs/action/RotateAbsolute_FeedbackMessage";
}
...
template<>
inline const char * data_type<turtlesim_msgs::action::RotateAbsolute>()
{
  return "turtlesim_msgs::action::RotateAbsolute";
}

template<>
inline const char * name<turtlesim_msgs::action::RotateAbsolute>()
{
  return "turtlesim_msgs/action/RotateAbsolute";
}
