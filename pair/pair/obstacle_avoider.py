...
class ObstacleAvoider(Node):
    def __init__(self):
        super().__init__('obstacle_avoider')  # base name, namespace makes it unique

        self.__publisher = self.create_publisher(Twist, 'cmd_vel', 1)

        self.__left_sensor_value = MAX_RANGE + 0.1
        self.__right_sensor_value = MAX_RANGE + 0.1
