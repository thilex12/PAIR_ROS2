...
[[deprecated("use turtlesim_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::srv::Kill_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::srv::Kill_Event & msg)
{
  return turtlesim_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::srv::Kill_Event>()
{
  return "turtlesim_msgs::srv::Kill_Event";
}

template<>
inline const char * name<turtlesim_msgs::srv::Kill_Event>()
{
  return "turtlesim_msgs/srv/Kill_Event";
}
