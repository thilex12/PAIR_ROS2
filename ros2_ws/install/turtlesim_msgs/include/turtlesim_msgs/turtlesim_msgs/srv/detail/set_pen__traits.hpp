...
inline void to_yaml(
  const turtlesim_msgs::srv::SetPen_Request & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const turtlesim_msgs::srv::SetPen_Request & msg)
{
  return turtlesim_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::srv::SetPen_Request>()
{
  return "turtlesim_msgs::srv::SetPen_Request";
}

template<>
inline const char * name<turtlesim_msgs::srv::SetPen_Request>()
{
  return "turtlesim_msgs/srv/SetPen_Request";
}
...
[[deprecated("use turtlesim_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::srv::SetPen_Response & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::srv::SetPen_Response & msg)
{
  return turtlesim_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::srv::SetPen_Response>()
{
  return "turtlesim_msgs::srv::SetPen_Response";
}

template<>
inline const char * name<turtlesim_msgs::srv::SetPen_Response>()
{
  return "turtlesim_msgs/srv/SetPen_Response";
}
...
[[deprecated("use turtlesim_msgs::srv::to_block_style_yaml() instead")]]
inline void to_yaml(
  const turtlesim_msgs::srv::SetPen_Event & msg,
  std::ostream & out, size_t indentation = 0)
{
  turtlesim_msgs::srv::to_block_style_yaml(msg, out, indentation);
}
...
[[deprecated("use turtlesim_msgs::srv::to_yaml() instead")]]
inline std::string to_yaml(const turtlesim_msgs::srv::SetPen_Event & msg)
{
  return turtlesim_msgs::srv::to_yaml(msg);
}

template<>
inline const char * data_type<turtlesim_msgs::srv::SetPen_Event>()
{
  return "turtlesim_msgs::srv::SetPen_Event";
}

template<>
inline const char * name<turtlesim_msgs::srv::SetPen_Event>()
{
  return "turtlesim_msgs/srv/SetPen_Event";
}
...
template<>
inline const char * data_type<turtlesim_msgs::srv::SetPen>()
{
  return "turtlesim_msgs::srv::SetPen";
}

template<>
inline const char * name<turtlesim_msgs::srv::SetPen>()
{
  return "turtlesim_msgs/srv/SetPen";
}
